...
class ExpansionTileController {
  ...
  static ExpansionTileController of(BuildContext context) {
    ...
    throw FlutterError.fromParts(<DiagnosticsNode>[
      ErrorSummary(
        'ExpansionTileController.of() called with a context that does not contain a CustomExpansionTile.',
      ),
      ErrorDescription(
        'No CustomExpansionTile ancestor could be found starting from the context that was passed to ExpansionTileController.of(). '
